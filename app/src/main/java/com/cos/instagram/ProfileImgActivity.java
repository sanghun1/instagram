...
public class ProfileImgActivity extends AppCompatActivity implements View.OnClickListener, SurfaceHolder.Callback {
...
//            Toast.makeText(MainActivity.this, "권한이 허용됨", Toast.LENGTH_SHORT).show();
            ...
            surfaceHolder.addCallback(ProfileImgActivity.this);
...
//            camera.setParameters(params);
        ...
        public void onPermissionDenied(List<String> deniedPermissions) {
            Toast.makeText(ProfileImgActivity.this, "권한이 거부됨\n" + deniedPermissions.toString(), Toast.LENGTH_SHORT).show();
        }
    };
}